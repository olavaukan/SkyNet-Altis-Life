...
//
// Modified for an Altis Life proof-of-concept by allowing it to run on players.
// This worked in the console to turn OPFOR against the player:
// nul = [player,"arifle_TRG20_ACO_pointer_F",100,10,east,1,1] execVM "ws_assassins.sqf";
_civarray = [];
if (_check) exitWith {
